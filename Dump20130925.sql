...
--
-- Host: 127.0.0.1    Database: entropy
-- ------------------------------------------------------
...
INSERT INTO `accounts` VALUES (1,'crovea','lol',1000,1000,2),(3,'crovea2','lol',0,0,3),(4,'crovea3','lol',0,0,4);
...
INSERT INTO `card_collections` VALUES (2,1,1),(3,1,3),(4,1,4);
...
BEGIN
	...
	insert into accounts values (null, _username, _password, 0,0, null);
...
-- Dump completed on 2013-09-25 12:46:48
